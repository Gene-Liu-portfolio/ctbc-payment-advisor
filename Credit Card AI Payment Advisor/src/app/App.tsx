...
import { recommendationsFromStructuredData, toRecommendation } from './recommendations';
import type { Recommendation } from './recommendations';
import { readStructuredSse } from './structuredStream';
import { createDelayedUpdateQueue } from './updateQueue';
...
export default function App() {
  ...
  const handleSendMessage = async (message: string) => {
    ...
    const assistantQueue = createDelayedUpdateQueue<Message>(
      updateAssistant,
      TOOL_TRACE_STEP_DELAY_MS,
    );
    const enqueueAssistantUpdate = assistantQueue.enqueue;
    const waitForAssistantUpdateQueue = assistantQueue.waitForDrain;
    ...
    try {
      ...
      await readStructuredSse(response.body, (event) => {
